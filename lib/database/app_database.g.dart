    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `user` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `user_id` TEXT, `name` TEXT)');
...
class _$UserDAO extends UserDAO {
  ...
  static final _userMapper = (Map<String, dynamic> row) =>
      UserEntity(row['user_id'] as String, row['name'] as String);
  ...
  @override
  Future<List<UserEntity>> getAllCondition() async {
